...
!function ($) {
  ...
  $('.header_space').css('height', height + 'px'); //set height of breadcrumb opacity div

  var opacity_height = $('.breadcrumbs').outerHeight();
  $('.opacity-breadcrumbs').css('height', opacity_height + 'px'); //height of about us opacity banner
